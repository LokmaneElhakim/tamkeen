  ...
  return (
    <section className="relative hero-background text-white py-20 md:py-32 flex items-center min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 right-10 w-48 h-48 bg-secondary/20 rounded-full blur-xl floating-animation"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-24 h-24 bg-primary/30 rounded-full blur-lg floating-animation"
          style={{ animationDelay: "4s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/3 w-16 h-16 bg-secondary/40 rounded-full blur-md floating-animation"
        ...
        <div className="max-w-xl md:max-w-2xl">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-white/20">
            ...
            <span className="text-sm font-medium">
              حدث تمكين الشباب الأول في غرداية
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-4 mb-12">
            <Button
              asChild
              size="lg"
              className="bg-[#d4af37] text-[#04174d] hover:bg-[#c09c20] transition-all duration-300 font-bold text-lg px-8 py-4 rounded-full shadow-lg hover:shadow-xl pulse-glow"
            >
              <Link
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#04174d] transition-all duration-300 font-bold text-lg px-8 py-4 rounded-full shadow-lg"
            >
      ...
      {/* Bottom fade */}
      <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#f2f2f2] to-transparent"></div>
    </section>
  );
}
